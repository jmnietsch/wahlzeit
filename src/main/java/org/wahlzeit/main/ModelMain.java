...
public abstract class ModelMain extends AbstractMain {
	...
	protected void startUp(String rootDir) throws Exception {
		...
		log.config(LogBuilder.createSystemMessage().addAction("init MusicalLocationPhotoFactory").toString());
		MusicalLocationPhotoFactory.initialize();
		//PhotoFactory.initialize();

		log.config(LogBuilder.createSystemMessage().addAction("load Photos").toString());
		MusicalLocationPhotoManager.getInstance().init();
	}
	...
	public void saveAll() throws IOException{
		...
		MusicalLocationPhotoManager.getInstance().savePhotos();
	...
	protected void createUser(String userId, String nickName, String emailAddress, String photoDir) throws Exception {
		...
		PhotoManager photoManager = MusicalLocationPhotoManager.getInstance();
